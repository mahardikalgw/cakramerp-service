...
export interface AttendanceServicePort {
  getMonthlyGrid(month: number, year: number, siteId?: string, departmentId?: string): Promise<any[]>
  getSummary(month: number, year: number, siteId?: string, departmentId?: string): Promise<any[]>
