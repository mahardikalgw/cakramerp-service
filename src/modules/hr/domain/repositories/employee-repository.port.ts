...
export interface EmployeeRepositoryPort {
  findAll(filters?: { search?: string; employmentType?: string; siteId?: string; departmentId?: string; status?: string; page?: number; limit?: number }): Promise<{ data: any[]; total: number }>
