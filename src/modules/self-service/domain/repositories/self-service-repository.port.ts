export const PROFILE_CHANGE_REQUEST_REPOSITORY = Symbol('PROFILE_CHANGE_REQUEST_REPOSITORY')
export const DISCREPANCY_REPORT_REPOSITORY = Symbol('DISCREPANCY_REPORT_REPOSITORY')
...
export interface LeaveBalanceRepositoryPort {
  ...
  findByEmployeeTypeAndYear(employeeId: string, leaveTypeId: string, year: number): Promise<any | null>
  create(data: any): Promise<any>
  update(id: string, data: any): Promise<any>
}
...
export interface LeaveRequestRepositoryPort {
  create(data: any): Promise<any>
  findByEmployeeId(employeeId: string, filters?: { status?: string; year?: number }): Promise<any[]>
  findById(id: string): Promise<any | null>
  update(id: string, data: any): Promise<any>
...
export interface ShiftScheduleRepositoryPort {
  findByEmployeeAndDateRange(employeeId: string, startDate: Date, endDate: Date): Promise<any[]>
  create(data: any): Promise<any>
...
export interface OvertimeRequestRepositoryPort {
  create(data: any): Promise<any>
  findByEmployeeId(employeeId: string, filters?: { status?: string }): Promise<any[]>
  findById(id: string): Promise<any | null>
  update(id: string, data: any): Promise<any>
