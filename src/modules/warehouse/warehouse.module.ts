...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      useClass: GoodsReceiptTypeOrmRepository,
    },
    {
      provide: STOCK_ISSUANCE_REPOSITORY,
      useClass: StockIssuanceTypeOrmRepository,
    },
    {
      provide: STOCK_OPNAME_REPOSITORY,
      useClass: StockOpnameTypeOrmRepository,
    },
