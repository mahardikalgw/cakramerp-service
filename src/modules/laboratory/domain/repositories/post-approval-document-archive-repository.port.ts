...
export interface PostApprovalDocumentArchiveRepositoryPort extends RepositoryPort<PostApprovalDocumentArchive> {
  findByContractId(contractId: string): Promise<PostApprovalDocumentArchive[]>;
