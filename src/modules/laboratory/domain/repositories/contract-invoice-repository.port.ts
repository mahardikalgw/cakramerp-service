...
export const CONTRACT_INVOICE_REPOSITORY = Symbol('CONTRACT_INVOICE_REPOSITORY');
...
export interface ContractInvoiceRepositoryPort {
  ...
  findByBillingPeriod(contractId: string, start: Date, end: Date): Promise<ContractInvoice | null>;
