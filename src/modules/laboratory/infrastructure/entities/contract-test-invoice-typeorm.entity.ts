...
export class ContractTestInvoiceTypeOrmEntity extends TypeOrmBaseEntity {
  ...
  @Column({ type: 'decimal', precision: 18, scale: 2, default: 0, name: 'initial_fee_applied' })
  ...
  @Column({ type: 'varchar', length: 255, nullable: true, name: 'payment_proof_filename' })
  declare paymentProofFilename: string | null;

  @Column({ type: 'timestamptz', nullable: true, name: 'payment_proof_uploaded_at' })
  ...
  @Column({ type: 'varchar', length: 255, nullable: true, name: 'payment_verified_by' })
  declare paymentVerifiedBy: string | null;

  @Column({ type: 'varchar', length: 255, nullable: true, name: 'payment_verified_by_name' })
