import { RepositoryPort, FindResult } from '../../../../shared/kernel/domain/repositories/repository.port'
...
export interface JournalEntryLineRepositoryPort {
  findByDateRange(start: Date, end: Date, filters?: { segment?: string; projectId?: string; costCenter?: string }): Promise<JournalEntryLine[]>
  findByAccountIdsAndDateRange(accountIds: string[], start: Date, end: Date): Promise<JournalEntryLine[]>
