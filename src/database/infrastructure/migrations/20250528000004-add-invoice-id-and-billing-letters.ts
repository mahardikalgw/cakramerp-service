...
export class AddInvoiceIdAndBillingLetters20250528000004 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX IF EXISTS idx_billing_letter_items_invoice;`)
    await queryRunner.query(`DROP INDEX IF EXISTS idx_billing_letter_items_letter;`)
    await queryRunner.query(`DROP INDEX IF EXISTS idx_billing_letters_supplier;`)
    await queryRunner.query(`DROP INDEX IF EXISTS idx_billing_letters_customer;`)
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS idx_gl_posting_queue_invoice_id;`)
    await queryRunner.query(`DROP INDEX IF EXISTS idx_journal_entries_invoice_id;`)
    ...
    await queryRunner.query(`ALTER TABLE gl_posting_queue DROP COLUMN IF EXISTS invoice_id;`)
    await queryRunner.query(`ALTER TABLE journal_entries DROP COLUMN IF EXISTS invoice_id;`)
    await queryRunner.query(`ALTER TABLE ap_subsidiary_ledger DROP COLUMN IF EXISTS invoice_id;`)
    await queryRunner.query(`ALTER TABLE ar_subsidiary_ledger DROP COLUMN IF EXISTS invoice_id;`)
    await queryRunner.query(`
