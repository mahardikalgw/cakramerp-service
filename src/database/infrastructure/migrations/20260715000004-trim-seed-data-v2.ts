 ...
 *
 * (V2: defensive against missing columns. The V1 of this migration
 * was 20260715000003-trim-seed-data, which crashed in production
 * with "column supplier_id does not exist".)
 *
 * Keep:
