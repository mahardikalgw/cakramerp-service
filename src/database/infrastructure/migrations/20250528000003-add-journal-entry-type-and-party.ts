...
export class AddJournalEntryTypeAndParty20250528000003 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX IF EXISTS idx_journal_entries_supplier_id;`)
    await queryRunner.query(`DROP INDEX IF EXISTS idx_journal_entries_customer_id;`)
    await queryRunner.query(`DROP INDEX IF EXISTS idx_journal_entries_journal_type;`)
    await queryRunner.query(`ALTER TABLE journal_entries DROP COLUMN IF EXISTS subsidiary_ledger_recorded;`)
    await queryRunner.query(`ALTER TABLE journal_entries DROP COLUMN IF EXISTS party_name;`)
    await queryRunner.query(`ALTER TABLE journal_entries DROP COLUMN IF EXISTS supplier_id;`)
    await queryRunner.query(`ALTER TABLE journal_entries DROP COLUMN IF EXISTS customer_id;`)
    await queryRunner.query(`ALTER TABLE journal_entries DROP COLUMN IF EXISTS journal_type;`)
  }
}
