...
export class SeedAdminData20250519000002 implements MigrationInterface {
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DELETE FROM user_roles WHERE role_id = 'b2c3d4e5-f6a7-8901-bcde-f23456789012';`,
    );
    await queryRunner.query(
      `DELETE FROM role_permissions WHERE role_id = 'b2c3d4e5-f6a7-8901-bcde-f23456789012';`,
    );
    await queryRunner.query(
