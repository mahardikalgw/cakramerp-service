...
export class AddEmployeeWorkTime20250527000006 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE employees DROP COLUMN IF EXISTS work_start_time;`)
    await queryRunner.query(`ALTER TABLE employees DROP COLUMN IF EXISTS work_end_time;`)
    await queryRunner.query(`ALTER TABLE employees DROP COLUMN IF EXISTS break_duration_minutes;`)
  }
}
