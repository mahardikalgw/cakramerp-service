...
export class SeedModuleData20250523000001 implements MigrationInterface {
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const roles = [
      { name: 'director', description: 'Company Director with full read access and approval authority' },
      { name: 'finance_manager', description: 'Finance Manager with full finance module access' },
      { name: 'hr_manager', description: 'HR Manager with full HR & payroll access' },
      { name: 'warehouse_manager', description: 'Warehouse Manager with full inventory access' },
      { name: 'site_manager', description: 'Site Manager with limited operational access' },
      { name: 'accountant', description: 'Accountant with finance read/write access' },
    ...
    const rolePermissions: Record<string, string[]> = {
      ...
      site_manager: [
        ...
        'equipment:read',
        'hr:read', 'employees:read', 'attendance:read',
        'reports:read',
        'dashboard:read',
      ],
      accountant: [
    ...
    const users = [
      { email: 'director@cakra.com', firstName: 'Budi', lastName: 'Santoso', role: 'director' },
      { email: 'finance@cakra.com', firstName: 'Siti', lastName: 'Rahayu', role: 'finance_manager' },
      { email: 'hr@cakra.com', firstName: 'Ahmad', lastName: 'Hidayat', role: 'hr_manager' },
      { email: 'warehouse@cakra.com', firstName: 'Dedi', lastName: 'Kurniawan', role: 'warehouse_manager' },
      { email: 'site@cakra.com', firstName: 'Eko', lastName: 'Prasetyo', role: 'site_manager' },
    ]
    ...
    const accounts = [
      ...
      { code: '1202', name: 'Cadangan Kerugian Piutang', type: 'asset', parent: '1200' },
      { code: '1300', name: 'Persediaan', type: 'asset', parent: '1000' },
      { code: '1301', name: 'Persediaan Bahan Baku', type: 'asset', parent: '1300' },
      { code: '1302', name: 'Persediaan Suku Cadang', type: 'asset', parent: '1300' },
      ...
      { code: '1509', name: 'Akumulasi Penyusutan', type: 'asset', parent: '1500' },

      // Liabilities (2xxx)
      { code: '2000', name: 'Kewajiban', type: 'liability', parent: null },
      { code: '2100', name: 'Hutang Usaha', type: 'liability', parent: '2000' },
      { code: '2101', name: 'Hutang Dagang', type: 'liability', parent: '2100' },
      { code: '2200', name: 'Hutang Pajak', type: 'liability', parent: '2000' },
      { code: '2201', name: 'Hutang PPN', type: 'liability', parent: '2200', taxCategory: 'ppn' },
      { code: '2202', name: 'Hutang PPh 21', type: 'liability', parent: '2200', taxCategory: 'pph21' },
      { code: '2203', name: 'Hutang PPh 23', type: 'liability', parent: '2200', taxCategory: 'pph23' },
      { code: '2300', name: 'Hutang BPJS', type: 'liability', parent: '2000' },
      { code: '2301', name: 'Hutang BPJS Kesehatan', type: 'liability', parent: '2300' },
      { code: '2302', name: 'Hutang BPJS Ketenagakerjaan', type: 'liability', parent: '2300' },
      { code: '2400', name: 'Hutang Jangka Panjang', type: 'liability', parent: '2000' },
      ...
      { code: '4100', name: 'Pendapatan Jasa Pertambangan', type: 'revenue', parent: '4000' },
      { code: '4200', name: 'Pendapatan Jasa Konstruksi', type: 'revenue', parent: '4000' },
      { code: '4300', name: 'Pendapatan Jasa Laboratorium', type: 'revenue', parent: '4000' },
      { code: '4900', name: 'Pendapatan Lain-lain', type: 'revenue', parent: '4000' },

      // COGS (5xxx)
      { code: '5000', name: 'Harga Pokok Penjualan', type: 'expense', parent: null },
      { code: '5100', name: 'Biaya Bahan Langsung', type: 'expense', parent: '5000' },
      { code: '5200', name: 'Biaya Tenaga Kerja Langsung', type: 'expense', parent: '5000' },
      { code: '5300', name: 'Biaya Overhead Proyek', type: 'expense', parent: '5000' },
      { code: '5301', name: 'Biaya Sewa Alat Berat', type: 'expense', parent: '5300' },
      { code: '5302', name: 'Biaya BBM & Pelumas', type: 'expense', parent: '5300' },
      { code: '5303', name: 'Biaya Pemeliharaan Alat', type: 'expense', parent: '5300' },

      // Operating Expenses (6xxx)
      { code: '6000', name: 'Biaya Operasional', type: 'expense', parent: null },
      { code: '6100', name: 'Biaya Gaji & Tunjangan', type: 'expense', parent: '6000' },
      { code: '6101', name: 'Gaji Karyawan', type: 'expense', parent: '6100' },
      { code: '6102', name: 'Tunjangan Makan', type: 'expense', parent: '6100' },
      { code: '6103', name: 'Tunjangan Transport', type: 'expense', parent: '6100' },
      { code: '6104', name: 'BPJS Perusahaan', type: 'expense', parent: '6100' },
      { code: '6105', name: 'THR & Bonus', type: 'expense', parent: '6100' },
      { code: '6200', name: 'Biaya Kantor', type: 'expense', parent: '6000' },
      { code: '6201', name: 'Biaya Listrik & Air', type: 'expense', parent: '6200' },
      { code: '6202', name: 'Biaya Telepon & Internet', type: 'expense', parent: '6200' },
      { code: '6203', name: 'Biaya ATK', type: 'expense', parent: '6200' },
      { code: '6300', name: 'Biaya Penyusutan', type: 'expense', parent: '6000' },
      { code: '6400', name: 'Biaya Perjalanan Dinas', type: 'expense', parent: '6000' },
      { code: '6500', name: 'Biaya Asuransi', type: 'expense', parent: '6000' },
      { code: '6900', name: 'Biaya Lain-lain', type: 'expense', parent: '6000' },
    ]
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    // Remove sample data
    await queryRunner.query(`DELETE FROM bank_accounts WHERE account_name = 'PT Cakram ERP'`)
    ...
    // Remove sample users
    const userEmails = ['director@cakra.com', 'finance@cakra.com', 'hr@cakra.com', 'warehouse@cakra.com', 'site@cakra.com']
    ...
    const roleNames = ['director', 'finance_manager', 'hr_manager', 'warehouse_manager', 'site_manager', 'accountant', 'hr_staff']
